...
class Storage:
    class Clients:
        def __init__(self, name_and_type, username):
            self.id = None
    ...
    def client_login(self, username, type_of_client, ip_address, port):
        ...
        if rez.count():
            ...
            user = self.Clients(username+type_of_client, username)
    ...
    def add_contact(self, username, contact_name):
        ...
        if not rez.count():
            ...
            try:
                ...
                return ['Такого пользователя не существует', contact_name]
            ...
            return ['У вас уже есть в контактах', contact_name]
    ...
    def del_contact(self, username, contact_name):
        ...
        if rez.count():
            ...
            return ['Такого контакта нет в вашем списке', contact_name]
