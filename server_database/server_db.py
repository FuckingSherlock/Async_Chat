...
class Storage:
    ...
    def add_contact(self, username, contact_name):
        ...
        if not rez.count():
            ...
            try:
                ...
                return [f'Пользователя с именем {contact_name} не существует']
            ...
            return [f'Пользователь {contact_name} вас уже есть в контактах']
    ...
    def del_contact(self, username, contact_name):
        ...
        if rez.count():
            ...
            return [f'Пользователя с именем {contact_name}  нет в вашем списке']
